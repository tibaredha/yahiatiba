# https://www.youtube.com/watch?v=O34vzdHOaEk&t=208s
...
pine_img <- image_read('R.png')

fonts_dataset <- font_files()

# fonts_dataset check the file column and copy paste it in  font_add("*",file.ttf)

font_add("Old English", "trado.ttf") #  font_add("Old English", "file.ttf")
